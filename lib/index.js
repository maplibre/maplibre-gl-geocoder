 ...
 * @param {Boolean} [options.whileTypingShowSuggestionsOnly=false] If `false`, indicates while typing the forwardGeocode and getSuggestions API will be called. If `true`, indicates that while typing only the getSuggestions API will be called and only suggestion results rendered.
