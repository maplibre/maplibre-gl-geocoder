 ...
 * @param {Boolean} [options.showResultsWhileTyping=false] If `fales`, indicates that search will only occur on enter key press. If `false`, indicates that the Geocoder will search on the input box being updated above the minLength option.
 * @example
 *
 * var GeoApi = {
