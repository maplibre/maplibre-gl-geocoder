...
-   `options` **[Object][55]** 
    ...
    -   `options.whileTypingShowSuggestionsOnly` **[Boolean][59]** If `false`, indicates while typing the forwardGeocode and getSuggestions API will be called. If `true`, indicates that while typing only the getSuggestions API will be called and only suggestion results rendered. (optional, default `false`)
